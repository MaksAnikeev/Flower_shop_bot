# Generated by Django 4.1 on 2023-01-18 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='flower_images', verbose_name='Картинка букета')),
                ('description', models.TextField(verbose_name='смысл букета')),
                ('composition', models.TextField(verbose_name='цветочный состав букета')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bunchs', to='flower_shop.categoryprice', verbose_name='ценовая категория')),
                ('reason', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bunchs', to='flower_shop.reason', verbose_name='повод для букета')),
            ],
            options={
                'verbose_name': 'букет',
